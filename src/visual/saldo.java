...
public class saldo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Corrente/Poupança");
        ...
        jLabel4.setText(" Saldo Bloquedo: ");
        ...
        jPanel5.setPreferredSize(new java.awt.Dimension(100, 34));
    ...
    private void jLabel10MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MousePressed
        if(jLabel3.getText().equals("Corrente")){
        cb.setPesquisa(jLabel9.getText());
        ContaBeans model = control.buscarSaldoCo(cb);
        jLabel7.setText(String.valueOf(model.getSaldo_corrente()));
        }else if (jLabel3.getText().equals("Poupança")){
            cb.setPesquisa(jLabel9.getText());
            ContaBeans model = control.buscarSaldoPo(cb);
            jLabel7.setText(String.valueOf(model.getSaldo_poupanca()));
        }
